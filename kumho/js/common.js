/* header와 footer 공통요소에 들어가는 jquery 포함 */
$(document).ready(function(){
   ...
   $('header').on('mouseleave', function(){
        ...
        //마우스를 아웃했을 때 fixed클래스를 삭제하는 건 맨 상단에 있을 때만 가능
        if(scrolling <= 0){ //scroll값이 0과 같거나 작을 때
   ...
   $('header').on('mouseleave', function(){
    ...
    /*
        모바일 메뉴를 클릭하면
        1. a 링크값을 삭제... (이동을 못하게 막아야 함)
        2. li에ㅔ open 클래스 추가
            open 없으면 추가
            open 있으면 삭제
            --> 한 번 클릭하면 열리고 두 번 클릭하면 닫힘
    */
