$(document).ready(function(){
    ...
    /* 
        ...
        2.클릭한 li이 aria-selected="true" 나머진 모두 false
        3.클릭한 li에서 aria-controls값을 가져와서
            하단 콘텐츠 중에서 같은 이름의 id를 가진 요소에만 
            active클래스를 추가
            .cts_history .tab_area .tab_cnt div[role="tabpanel"]

            find라는 명령으로 id가  aria-controls값과 같은 요소를 찾아야 함
            find는 하위요소를 검색하는 기능
            선택자가 tabpanel을 직접 선택하는게 아닌 그 부모요소를 선택해서
            하위요소를 검색하게 해야함
    */
